...
## P2
- [ ] Add finer-grained Klasse 1-4 (Grundschule) sublevels to L1 (e.g. Zahlenraum bis 20/100/1000, Uhrzeit, Waehrung) per gap identified in `docs/curriculum-coverage-klasse-1-12.md`
- [ ] Strengthen Wahrscheinlichkeit (`1.4.2.a`) and Kombinatorik (`2.6.1.*`) content depth per gap identified in `docs/curriculum-coverage-klasse-1-12.md`
