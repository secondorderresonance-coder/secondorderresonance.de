...
- [ ] Add a fine-grained Klasse 1-2 sublevel branch to the L1 taxonomy (Zahlraum bis 100, Additions-/Subtraktionsstrategien ohne Uebertrag, Formen/Uhrzeit) and seed it with a first small task batch, per the gap identified in `docs/curriculum-coverage-klasse-1-12.md`
