...
- [ ] Close Klasse 7-8 curriculum gaps identified in `docs/curriculum-coverage-klasse-1-12.md`: add sublevels for Zinsrechnung/Zinseszins, Kongruenzsaetze/Dreieckskonstruktionen, and Mittelstufe-Achsen-/Punktsymmetrie
