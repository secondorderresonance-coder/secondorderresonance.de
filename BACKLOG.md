...
- [ ] Add a dedicated Klasse-1-2-Fruehphase sublevel (Zahlenraum bis 20/100, kleines Einmaleins) under 1.1.1, identified as a coverage gap in `docs/curriculum-coverage-klasse-1-12.md`
- [ ] Add a dedicated Zinsrechnung sublevel under 1.1.2 (Klasse 7), identified as a coverage gap in `docs/curriculum-coverage-klasse-1-12.md`
