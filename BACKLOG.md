...
- [ ] Add seed tasks for identified L1-L3 coverage gaps from curriculum matrix: Kegelschnitte, Normalverteilung/Hypothesentest, Sinus-/Kosinussatz, Gleichungssysteme 3x3, Antiproportionale Zuordnungen, Baumdiagramm, Betragsungleichungen
