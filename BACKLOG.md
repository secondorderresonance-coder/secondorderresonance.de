...
- [ ] Add a Klassenstufe metadata tag per sublevel in `app/data/archive-content.js` so the Klasse 1-12 coverage matrix (`docs/curriculum-coverage-matrix-l1-l3.md`) becomes machine-readable and can later drive a grade-level filter in the archive UI
