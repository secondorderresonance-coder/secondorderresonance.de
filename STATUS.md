...
- **T-4-025** (Fourierreihen und L2-Konvergenz): Orthonormalsystem, Koeffizientenberechnung, Parseval-Kontrolle, Gibbs-Phaenomen.
- **T-5-025** (Modellpraediktive Regelung / MPC): Receding-horizon-Prinzip, QP/NLP-Subproblem, Constraint-Handhabung, Stabilitaet via Terminalkosten.
- **T-6-025** (Spektrale Methoden und Tschebyscheff-Approximation): Globale Basis vs. FDM, exponentielle Konvergenz, FFT/DCT, Gibbs-Warnung.
