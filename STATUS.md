...
- **T-4-025** (Determinanten: Entwicklungssatz und Leibniz-Formel): Laplace-Entwicklung nach Nullspalten/-zeilen, Kofaktoren, Vorzeichen-Schachbrettmuster.
- **T-5-025** (Diskretisierung kontinuierlicher Regelstrecken): ZOH, Euler-Vorwaerts/Rueckwaerts, Tustin/Bilinear, Stabilitaetsmapping s->z.
- **T-6-025** (Variance Reduction: SVRG und SAGA): Kontrollvariaten, Gradientenspeicher, lineare Konvergenz bei starker Konvexitaet.
