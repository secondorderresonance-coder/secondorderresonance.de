...
- **T-4-025** (Rayleigh-Quotient und Eigenwertnahe): Eigenwertapproximation ueber Quotient und Residuumscheck.
- **T-5-025** (Frequenzvorsteuerung im Tracking): Aufgabenteilung zwischen Vorsteuerung und Rueckfuehrung.
- **T-6-025** (BFGS vs. L-BFGS): Speicher-/Skalierungsunterschiede und praktische Wahl in grosser Dimension.
