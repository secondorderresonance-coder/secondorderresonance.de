...
- **T-4-025** (Jordansche Normalform und nilpotente Bloecke): Jordan-Blockstruktur, Hauptvektoren, Aehnlichkeitstransformation fuer defekte Matrizen.
- **T-5-025** (Model Predictive Control Grundlagen): Rolling-Horizon-Optimierung, QP-Formulierung mit Stell-/Zustandsbeschraenkungen, terminale Stabilitaet.
- **T-6-025** (Semidefinite Programmierung und LMI-Formulierungen): SDP-Kegel, Lyapunov-LMI, Schur-Komplement, Interior-Point-Loeser.
