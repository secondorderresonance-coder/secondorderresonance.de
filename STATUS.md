...
- **T-4-025** (Normierte Raeume und Aequivalenz von Normen): Aequivalenzkette, Kompaktheitsargument auf Einheitssphaerae, endlich- vs. unendlichdimensional.
- **T-5-025** (Modellpraediktive Regelung / MPC Grundprinzip): gleitender Horizont, QP-Subproblem, terminale Menge und rekursive Zulaessigkeit.
- **T-6-025** (A-posteriori Fehlerabschaetzung und adaptive FEM): Residualindikator, Markierungsstrategie, Konvergenzratenvergleich adaptiv vs. gleichmaessig.
