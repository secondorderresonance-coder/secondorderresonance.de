...
## Last completed task (v1.2.22)
Twentieth focused L4-L6 archive expansion batch:

### Changes in this iteration
- **T-4-026** (Orthogonale Projektion in Unterraeume): Projektorformel, Orthogonalitaetsbedingung und numerische Hinweise.
- **T-5-026** (Zustandsrueckfuehrung mit Vorfilter): Rolle von N fuer stationaeres Tracking bei `u=-Kx+N*r`.
- **T-6-026** (Preconditioning im CG): Konditionsverbesserung und Iterations-/Laufzeittradeoff.
...
- marker check: `T-4-026`, `T-5-026`, `T-6-026`

### Blockers
None.

### Next logical step
- Continue P2 with next small L4-L6 batch (`T-4-027`, `T-5-027`, `T-6-027`) while preserving the didactic explanation template.
