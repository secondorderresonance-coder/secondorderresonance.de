...
- **T-4-025** (Duale Raeume und Linearformen): Dual basis, Linearformen als Kovektoren, Isomorphie V**/V fuer endliche Dimension.
- **T-5-025** (Modellpraediktive Regelung MPC Grundidee): Gleitender Horizont, Online-QP/NLP, Beschraenkungserfuellung, terminale Stabilitaetsbedingung.
- **T-6-025** (Semidefinite Programmierung SDP): PSD-Kegel, LMI-Nebenbedingungen, Interior-Point-Solver, Dualitaetsgap-Schnellcheck.
