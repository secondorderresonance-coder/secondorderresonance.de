...
window.SOR_ARCHIVE = {
    ...
    tasks: buildTaskArchive([
        ...
        { id: "T-1-036", title: "Brueche multiplizieren", level: "1", sublevel: "1.1.2.c", topic: "Bruchrechnung", tags: ["bruch","multiplikation"], difficulty: "leicht", question: "Berechne 2/3 * 3/4.", answer: "1/2", explanation: "Zaehler und Nenner getrennt multiplizieren: (2*3)/(3*4) = 6/12 = 1/2.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-1-037", title: "Brueche dividieren", level: "1", sublevel: "1.1.2.c", topic: "Bruchrechnung", tags: ["bruch","division"], difficulty: "leicht", question: "Berechne 3/4 : 3/8.", answer: "2", explanation: "Division durch einen Bruch = Multiplikation mit dem Kehrwert: 3/4 * 8/3 = 24/12 = 2.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-1-038", title: "Proportionale Zuordnung Dreisatz", level: "1", sublevel: "1.3.1.a", topic: "Proportionalitaet", tags: ["proportional","dreisatz"], difficulty: "leicht", question: "Ein Auto faehrt konstant und legt in 2 Stunden 120 km zurueck. Wie weit kommt es in 5 Stunden?", answer: "300 km", explanation: "Proportional: 120/2 = 60 km/h. 5 * 60 = 300 km.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-1-039", title: "Volumen Zylinder", level: "1", sublevel: "1.2.2.a", topic: "Geometrie", tags: ["zylinder","volumen"], difficulty: "mittel", question: "Ein Zylinder hat Radius 3 cm und Hoehe 10 cm. Berechne das Volumen. (Ergebnis mit pi angeben.)", answer: "90*pi cm^3 ca. 282,7 cm^3", explanation: "V = pi * r^2 * h = pi * 9 * 10 = 90*pi.", type: "kurzantwort", estimatedTime: 3 },
        { id: "T-1-040", title: "Einfaches Zufallsexperiment Wuerfel", level: "1", sublevel: "1.4.2.a", topic: "Wahrscheinlichkeit", tags: ["wuerfel","zufall"], difficulty: "leicht", question: "Mit einem fairen Wuerfel wird einmal gewuerfelt. Wie gross ist die Wahrscheinlichkeit, eine Zahl groesser als 4 zu wuerfeln?", answer: "1/3", explanation: "Guenstige Ergebnisse: {5, 6} = 2. Gesamt: 6. P = 2/6 = 1/3.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-1-041", title: "Schriftliche Division", level: "1", sublevel: "1.1.1.b", topic: "Grundrechenarten", tags: ["division","schriftlich"], difficulty: "leicht", question: "Berechne 672 : 4 schriftlich.", answer: "168", explanation: "6:4=1 Rest 2, naechste Ziffer ergibt 27:4=6 Rest 3, dann 32:4=8. Ergebnis: 168.", type: "kurzantwort", estimatedTime: 3 },
        ...
        { id: "T-2-036", title: "Lineare Ungleichung loesen", level: "2", sublevel: "2.1.4.a", topic: "Ungleichungen", tags: ["ungleichung","linear"], difficulty: "mittel", question: "Loese 3x - 6 > 0.", answer: "x > 2", explanation: "3x > 6, also x > 2. Das Ungleichungszeichen bleibt bei Multiplikation/Division mit positiven Zahlen erhalten.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-2-037", title: "Senkrechte Geraden", level: "2", sublevel: "2.2.2.b", topic: "Lineare Funktionen", tags: ["gerade","senkrecht","steigung"], difficulty: "mittel", question: "Eine Gerade hat die Steigung m = 2. Wie gross ist die Steigung einer dazu senkrechten Geraden?", answer: "-1/2", explanation: "Zwei Geraden sind senkrecht, wenn das Produkt ihrer Steigungen -1 ergibt: m1 * m2 = -1. Also m2 = -1/2.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-2-038", title: "Tangensfunktion Standardwert", level: "2", sublevel: "2.4.3.b", topic: "Trigonometrie", tags: ["tan","einheitskreis"], difficulty: "mittel", question: "Berechne tan(45 Grad).", answer: "1", explanation: "tan(45) = sin(45)/cos(45) = (sqrt(2)/2)/(sqrt(2)/2) = 1.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-2-039", title: "Binomialkoeffizient berechnen", level: "2", sublevel: "2.6.1.b", topic: "Kombinatorik", tags: ["binomialkoeffizient","kombinationen"], difficulty: "mittel", question: "Berechne C(6,2) (6 ueber 2).", answer: "15", explanation: "C(n,k) = n! / (k! * (n-k)!). C(6,2) = 6!/(2!*4!) = (6*5)/(2*1) = 15.", type: "kurzantwort", estimatedTime: 3 },
        { id: "T-2-040", title: "Aehnliche Figuren Seitenlaenge", level: "2", sublevel: "2.5.1.b", topic: "Geometrie", tags: ["aehnlichkeit","massstab"], difficulty: "mittel", question: "Zwei aehnliche Dreiecke haben den Aehnlichkeitsfaktor k = 3. Die entsprechende Seite des kleineren Dreiecks ist 4 cm. Wie lang ist diese Seite beim groesseren Dreieck?", answer: "12 cm", explanation: "Bei aehnlichen Figuren werden alle Laengen mit dem Aehnlichkeitsfaktor multipliziert: 4 * 3 = 12 cm.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-2-041", title: "LGS mit 3 Unbekannten", level: "2", sublevel: "2.1.2.b", topic: "Gleichungssysteme", tags: ["lgs","drei-unbekannte"], difficulty: "schwer", question: "Loese das System: x+y+z=6, x+y=4, y+z=5.", answer: "x=1, y=3, z=2", explanation: "Aus G2 folgt x+y=4. G1-G2: z=6-4=2. G3: y=5-z=5-2=3. G2: x=4-3=1.", type: "kurzantwort", estimatedTime: 4 },
        {
            id: "T-3-001",
        ...
        { id: "T-3-036", title: "Vollstaendige Kurvendiskussion", level: "3", sublevel: "3.1.2.a", topic: "Analysis", tags: ["kurvendiskussion","extremstellen","wendepunkt"], difficulty: "schwer", question: "Fuehre eine Kurvendiskussion fuer f(x) = x^3 - 3x durch: Nullstellen, Extremstellen, Wendepunkte.", answer: "NS: x=0, x=sqrt(3), x=-sqrt(3). Hochpunkt: x=-1, Tiefpunkt: x=1. Wendepunkt: x=0", explanation: "f(x)=x(x^2-3): NS bei 0 und +/-sqrt(3). f'(x)=3x^2-3=0 => x=+/-1. f''(-1)=-6<0 (Hoch), f''(1)=6>0 (Tief). f''(x)=6x=0 => x=0 (Wendepunkt).", type: "kurzantwort", estimatedTime: 6 },
        { id: "T-3-037", title: "Optimierungsaufgabe Behaelter", level: "3", sublevel: "3.1.2.b", topic: "Analysis", tags: ["optimierung","extremwert","anwendung"], difficulty: "schwer", question: "Ein oben offener Quader mit quadratischer Grundflaeche soll Volumen V=32 cm^3 haben. Minimiere die Oberflaeche S.", answer: "a=4 cm, h=2 cm (minimale Oberflaeche)", explanation: "V=a^2*h=32 => h=32/a^2. S=a^2+4*a*h = a^2+128/a. S'=2a-128/a^2=0 => a^3=64 => a=4, h=32/16=2.", type: "kurzantwort", estimatedTime: 6 },
        { id: "T-3-038", title: "Geometrische Reihe Summe", level: "3", sublevel: "3.1.5.a", topic: "Analysis", tags: ["reihe","geometrisch","summenformel"], difficulty: "mittel", question: "Berechne die Summe: S = 1 + 2 + 4 + 8 + 16.", answer: "31", explanation: "Geometrische Reihe mit q=2, n=5 Glieder: S = (q^n - 1)/(q-1) = (2^5-1)/(2-1) = 31/1 = 31.", type: "kurzantwort", estimatedTime: 3 },
        { id: "T-3-039", title: "Bayes-Theorem anwenden", level: "3", sublevel: "3.2.1.b", topic: "Stochastik", tags: ["bayes","bedingte-wahrscheinlichkeit"], difficulty: "schwer", question: "Ein Test erkennt eine Krankheit mit P(T+|K)=0,9 und P(T+|kein K)=0,05. Praevalenz P(K)=0,01. Bestimme P(K|T+).", answer: "ca. 0,154 (15,4%)", explanation: "Bayes: P(K|T+)=P(T+|K)*P(K)/[P(T+|K)*P(K)+P(T+|kK)*P(kK)] = 0,9*0,01/(0,9*0,01+0,05*0,99) = 0,009/0,0585 ≈ 0,154.", type: "kurzantwort", estimatedTime: 5 },
        { id: "T-3-040", title: "Normalverteilung standardisieren", level: "3", sublevel: "3.2.2.c", topic: "Stochastik", tags: ["normalverteilung","standardisierung"], difficulty: "schwer", question: "X ist normalverteilt mit Mittelwert 100 und Standardabweichung 15. Berechne P(X ≤ 115).", answer: "Phi(1) ca. 0,841 (84,1%)", explanation: "Standardisierung: z = (X-mu)/sigma = (115-100)/15 = 1. Aus der Standardnormalverteilung: Phi(1) ≈ 0,841.", type: "kurzantwort", estimatedTime: 4 },
        { id: "T-3-041", title: "Matrix Addition und skalare Multiplikation", level: "3", sublevel: "3.4.1.a", topic: "Matrizen", tags: ["matrix","addition","skalar"], difficulty: "leicht", question: "Berechne A + 2*B fuer A=[[1,2],[3,4]] und B=[[1,0],[0,1]].", answer: "[[3,2],[3,6]]", explanation: "2*B = [[2,0],[0,2]]. A+2*B = [[1+2,2+0],[3+0,4+2]] = [[3,2],[3,6]].", type: "kurzantwort", estimatedTime: 3 },
