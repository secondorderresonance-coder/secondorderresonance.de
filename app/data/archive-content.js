...
window.SOR_ARCHIVE = {
    ...
    tasks: buildTaskArchive([
        ...
        { id: "T-1-036", title: "Schriftliche Division", level: "1", sublevel: "1.1.1.b", topic: "Grundrechenarten", tags: ["division","schriftlich"], difficulty: "leicht", question: "Berechne 756 geteilt durch 4 schriftlich.", answer: "189", explanation: "756 : 4: 7:4=1 Rest 3, 35:4=8 Rest 3, 36:4=9. Ergebnis: 189.", type: "kurzantwort", estimatedTime: 3 },
        { id: "T-1-037", title: "Brüche multiplizieren", level: "1", sublevel: "1.1.2.c", topic: "Bruchrechnung", tags: ["bruch","multiplikation"], difficulty: "leicht", question: "Berechne 2/3 * 3/4.", answer: "1/2", explanation: "Zaehler: 2*3=6. Nenner: 3*4=12. 6/12 = 1/2.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-1-038", title: "Brüche dividieren", level: "1", sublevel: "1.1.2.c", topic: "Bruchrechnung", tags: ["bruch","division"], difficulty: "leicht", question: "Berechne 3/5 : 6/10.", answer: "1", explanation: "Dividieren = Multiplizieren mit Kehrwert: 3/5 * 10/6 = 30/30 = 1.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-1-039", title: "Volumen Zylinder", level: "1", sublevel: "1.2.2.a", topic: "Geometrie", tags: ["zylinder","volumen"], difficulty: "leicht", question: "Ein Zylinder hat Radius 3 cm und Hoehe 10 cm. Berechne das Volumen (mit pi angeben).", answer: "90*pi cm^3 ≈ 282,7 cm^3", explanation: "V = pi * r^2 * h = pi * 9 * 10 = 90*pi.", type: "kurzantwort", estimatedTime: 3 },
        { id: "T-1-040", title: "Proportionale Zuordnung", level: "1", sublevel: "1.3.1.a", topic: "Proportionalitaet", tags: ["proportional","dreisatz"], difficulty: "leicht", question: "1 Liter Milch kostet 1,20 Euro. Was kosten 4,5 Liter?", answer: "5,40 Euro", explanation: "Proportional: 1 Liter → 1,20 Euro. 4,5 Liter → 4,5 * 1,20 = 5,40 Euro.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-1-041", title: "Einfaches Zufallsexperiment", level: "1", sublevel: "1.4.2.a", topic: "Wahrscheinlichkeit", tags: ["zufall","muenze"], difficulty: "leicht", question: "Eine faire Muenze wird geworfen. Wie gross ist die Wahrscheinlichkeit fuer Kopf?", answer: "1/2 = 50 %", explanation: "Es gibt 2 gleichwahrscheinliche Ergebnisse (Kopf, Zahl). P(Kopf) = 1/2.", type: "kurzantwort", estimatedTime: 1 },
        ...
        { id: "T-2-036", title: "Formel nach Variable umstellen", level: "2", sublevel: "2.1.1.b", topic: "Gleichungen", tags: ["formelumstellung","physik"], difficulty: "mittel", question: "Stelle die Formel v = s/t nach t um.", answer: "t = s/v", explanation: "Beide Seiten mit t multiplizieren: v*t = s. Dann durch v teilen: t = s/v.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-2-037", title: "Quadratische Gleichung loesen", level: "2", sublevel: "2.1.3.a", topic: "Gleichungen", tags: ["quadratisch","diskriminante"], difficulty: "mittel", question: "Loese x^2 - 5x + 6 = 0.", answer: "x = 2 oder x = 3", explanation: "Diskriminante: D = 25-24 = 1. x = (5 ± 1)/2. x1 = 3, x2 = 2.", type: "kurzantwort", estimatedTime: 3 },
        { id: "T-2-038", title: "Quadratische Faktorisierung", level: "2", sublevel: "2.1.3.b", topic: "Gleichungen", tags: ["faktorisierung","quadratisch"], difficulty: "mittel", question: "Faktorisiere x^2 - 4.", answer: "(x-2)(x+2)", explanation: "Drittes binomisches Gesetz: a^2 - b^2 = (a-b)(a+b). Hier a=x, b=2.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-2-039", title: "Lineare Ungleichung loesen", level: "2", sublevel: "2.1.4.a", topic: "Gleichungen", tags: ["ungleichung","linear"], difficulty: "mittel", question: "Loese 3x - 4 > 5.", answer: "x > 3", explanation: "3x > 9. Durch 3 teilen (positiv, Ungleichung bleibt): x > 3.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-2-040", title: "Binomialkoeffizient berechnen", level: "2", sublevel: "2.6.1.b", topic: "Kombinatorik", tags: ["binomialkoeffizient","kombinationen"], difficulty: "mittel", question: "Berechne C(6,2) (Binomialkoeffizient '6 über 2').", answer: "15", explanation: "C(6,2) = 6! / (2! * 4!) = (6*5) / (2*1) = 15.", type: "kurzantwort", estimatedTime: 2 },
        { id: "T-2-041", title: "Baumdiagramm Wahrscheinlichkeit", level: "2", sublevel: "2.6.2.b", topic: "Wahrscheinlichkeit", tags: ["baumdiagramm","mehrstufig"], difficulty: "mittel", question: "Eine Urne hat 3 rote und 2 blaue Kugeln. Eine Kugel wird gezogen (ohne Zuruecklegen), dann eine zweite. Wie gross ist P(beide rot)?", answer: "3/10", explanation: "P(rot) = 3/5. P(rot|rot schon gezogen) = 2/4 = 1/2. P(beide rot) = 3/5 * 1/2 = 3/10.", type: "kurzantwort", estimatedTime: 4 },
        ...
        { id: "T-3-036", title: "Extremstellen bestimmen", level: "3", sublevel: "3.1.1.b", topic: "Analysis", tags: ["extremstellen","ableitung","monotonie"], difficulty: "mittel", question: "Finde die Extremstellen von f(x) = x^3 - 12x.", answer: "Minimum bei x = 2, Maximum bei x = -2", explanation: "f'(x) = 3x^2 - 12 = 0 → x^2 = 4 → x = ±2. f''(x) = 6x. f''(2) = 12 > 0 (Min), f''(-2) = -12 < 0 (Max).", type: "kurzantwort", estimatedTime: 4 },
        { id: "T-3-037", title: "Kurvendiskussion vollstaendig", level: "3", sublevel: "3.1.2.a", topic: "Analysis", tags: ["kurvendiskussion","vollstaendig"], difficulty: "schwer", question: "Bestimme fuer f(x) = x^3 - 3x: Nullstellen, Extrema und Wendepunkte.", answer: "Nullstellen: x=0, x=sqrt(3), x=-sqrt(3); Maxima/Minima bei x=±1; Wendepunkt (0|0)", explanation: "f(x)=0: x(x^2-3)=0. f'=3x^2-3=0: x=±1. f(1)=-2 (Min), f(-1)=2 (Max). f''=6x=0: x=0, VZW bestaetigt WP.", type: "kurzantwort", estimatedTime: 6 },
        { id: "T-3-038", title: "Partielle Integration", level: "3", sublevel: "3.1.3.d", topic: "Analysis", tags: ["partielle-integration","integral"], difficulty: "schwer", question: "Berechne ∫ x * e^x dx.", answer: "x * e^x - e^x + C = (x-1) * e^x + C", explanation: "Partielle Integration: u=x, v'=e^x. u'=1, v=e^x. ∫ x*e^x dx = x*e^x - ∫ e^x dx = x*e^x - e^x + C.", type: "kurzantwort", estimatedTime: 4 },
        { id: "T-3-039", title: "Exponentielles Wachstumsmodell", level: "3", sublevel: "3.1.4.b", topic: "Analysis", tags: ["wachstum","exponentialfunktion","modell"], difficulty: "mittel", question: "Eine Bakterienkultur waechst nach N(t) = 500 * e^(0,1t). Wie gross ist die Population nach 10 Stunden?", answer: "500 * e ≈ 1359", explanation: "N(10) = 500 * e^(0,1*10) = 500 * e^1 = 500*e ≈ 1359.", type: "kurzantwort", estimatedTime: 3 },
        { id: "T-3-040", title: "Bayes-Theorem anwenden", level: "3", sublevel: "3.2.1.b", topic: "Stochastik", tags: ["bayes","bedingte-wahrscheinlichkeit"], difficulty: "schwer", question: "Ein Test erkennt eine Krankheit (Praevalenz 1%) mit P(+|krank)=0,95 und P(+|gesund)=0,05. Wie gross ist P(krank|+)?", answer: "≈ 16,1 %", explanation: "P(krank|+) = P(+|krank)*P(krank) / P(+). P(+) = 0,95*0,01 + 0,05*0,99 = 0,059. P(krank|+) = 0,0095/0,059 ≈ 0,161.", type: "kurzantwort", estimatedTime: 5 },
        { id: "T-3-041", title: "Normalverteilung Standardisierung", level: "3", sublevel: "3.2.2.c", topic: "Stochastik", tags: ["normalverteilung","standardisierung"], difficulty: "schwer", question: "X ~ N(mu=100, sigma=15). Berechne P(X <= 115) mit der Standardnormalverteilung.", answer: "P(Z <= 1) ≈ 0,8413", explanation: "Standardisieren: Z = (115-100)/15 = 1. Aus der z-Tabelle: P(Z<=1) ≈ 0,8413.", type: "kurzantwort", estimatedTime: 4 },
