...
window.SOR_ARCHIVE = {
    ...
    placementQuestions: [
        ...
        { id: "P06", level: "2", sublevel: "2.1.1", topic: "Gleichungen", prompt: "L?se 2x + 4 = 12.", options: ["x=2", "x=3", "x=4", "x=6"], correctIndex: 2 },
        { id: "P07", level: "2", sublevel: "2.1.1", topic: "Umformen", prompt: "Stelle v=s/t nach t um.", options: ["t=v/s", "t=s/v", "t=sv", "t=s-v"], correctIndex: 1 },
        { id: "P08", level: "2", sublevel: "2.2", topic: "Lineare Funktion", prompt: "f(x)=3x-1. Wie gro? ist f(2)?", options: ["4", "5", "6", "7"], correctIndex: 1 },
        ...
        { id: "P26", level: "6", sublevel: "6.1.1", topic: "PDE", prompt: "W?rmeleitungsgleichung ist ...", options: ["elliptisch", "parabolisch", "hyperbolisch", "algebraisch"], correctIndex: 1 },
        { id: "P27", level: "6", sublevel: "6.2", topic: "Stochastik", prompt: "Wiener-Prozess hat ...", options: ["deterministische Schritte", "unabh?ngige normalverteilte Inkremente", "endliche Werte", "periodische L?sungen"], correctIndex: 1 },
        { id: "P28", level: "6", sublevel: "6.1", topic: "Numerik", prompt: "RK4 hat globale Ordnung ...", options: ["1", "2", "3", "4"], correctIndex: 3 },
        { id: "P29", level: "6", sublevel: "6.1.1", topic: "FEM", prompt: "FEM basiert oft auf ...", options: ["Energie-Minimierung", "exakter L?sung", "Diskretisierung ohne Gitter", "nur Zufall"], correctIndex: 0 },
        { id: "P30", level: "6", sublevel: "6.2", topic: "Optimierung", prompt: "KKT-Bedingungen sind ...", options: ["Ableitungsregeln", "Optimalit?tsbedingungen mit Nebenbedingungen", "Integrationsregeln", "Fehlersch?tzer"], correctIndex: 1 }
    ]
};
